...
public class Smartphone extends Product{
    public Smartphone(ProductTypes type, String brand, String model, String description, double displaySize, double storageCap, double purchasePrice, double sellPrice, int itemId) {
