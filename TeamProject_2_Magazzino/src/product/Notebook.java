...
public class Notebook extends Product {
    public Notebook(ProductTypes type, String producer, String model, String description, double displaySize, double storageCap, double purchasePrice, double sellPrice, int itemId) {
